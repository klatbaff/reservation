...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
	...
	try {
        ...
        //firstname, name, place, startDate, endDate et le cleanOption.
        //la variable reservation contient la classe ainsi que les fonctions que nous avons paramétrer dans le model reservation. 
